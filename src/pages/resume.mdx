...
- Led architecture and delivery for a backend-for-frontend project. Simplified interfacing with microservice APIs through one **GraphQL API**, leveraging highly scalable event-driven, serverless architecture.
