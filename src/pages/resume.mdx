...
- Architected and built a backend-for-frontend project, to simplify interface with microservices through one **GraphQL API**, leveraging highly scalable event-driven, serverless architecture.
